...
namespace ConcentMusic
{
    class MusicDownloader
    {
        ...
        {
            var notDownloadedTracks = TelegramBot.t_racksList.Where(x => x._trackState == TrackState.NotDownloaded);
        ...
        private void DownloadAudio(int trackId)
        {
            ...
            TelegramBot.t_racksList.Where(x => x._trackId == trackId).First()._trackState = TrackState.Downloading;
            ...
            TelegramBot.t_racksList.Where(x => x._trackId == trackId).First()._trackState = TrackState.Downloaded;
